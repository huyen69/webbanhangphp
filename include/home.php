<?php
$con = mysqli_connect("localhost", "root", "", "lapdev_shop");
        ...
        <div class="row">
            ...
            <div class="agileinfo-ads-display col-lg-9">
                <div class="wrapper">
                            ...
                            <div class="col-md-4 product-men mt-5">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item text-center" >
                                        <img src="images/<?php echo $row_sanpham['sanpham_image'] ?>" alt="" style="height:auto; width:200px;">
                                    ...
                                    <div class="item-info-product text-center border-top mt-4">
                                        ...
                                        <div class="info-product-price my-2" style="display: grid;">
                                            <span class="item_price"><?php echo number_format($row_sanpham['sanpham_giakhuyenmai'], 0, ',', '.') ?> VNĐ</span>
                                            <del><?php echo number_format($row_sanpham['sanpham_gia'], 0, ',', '.') ?> VNĐ</del>
                                        </div>
                                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                            <form action="?quanly=giohang" method="post">
                                                <fieldset>
                                                    ...
                                                    <input type="hidden" name="giasanpham" value="<?php echo number_format($row_sanpham['sanpham_giakhuyenmai'], 0, ',', '.') ?> VNĐ" />
                    ...
                    ?>
                    <div class="row">
                        <img src="images/slider2.jpg" alt style="width:900px">
                    </div>
                </div>
            </div>
            <!-- //product left -->
            ...
            <div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
                <div class="side-bar p-sm-4 p-3">
                    <div class="search-hotel border-bottom py-2">
                        ...
                        <form action="./include/timkiem.php" method="post">
                            <input type="search" placeholder="laptop..." name="search" required="">
                    ...
                    <div class="customer-rev border-bottom left-side py-2">
                        <h3 class="agileits-sear-head mb-3">Lượt đánh giá</h3>
                        <ul>
                            <li>
                                <a href="#">
                            ...
                            <div class="scroll">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                        <img src="images/<?php echo $row_sanpham_sidebar['sanpham_image']; ?>" alt style="height:auto" class="img-fluid">
                                    </div>
                                    <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
                                        <a href=""><?php echo $row_sanpham_sidebar['sanpham_name']; ?></a>
                                        <a href="" class="price-mar mt-2"><?php echo number_format($row_sanpham_sidebar['sanpham_giakhuyenmai'], 0, ',', '.') ?> VNĐ</a>
                                        <del><?php echo number_format($row_sanpham_sidebar['sanpham_gia'], 0, ',', '.') ?> VNĐ</del>
                                    </div>
                                </div>
                                <?php
                                    }
