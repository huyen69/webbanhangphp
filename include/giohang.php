...
// $sql_khachhang = mysqli_query($con, "SELECT * FROM tbl_khachhang WHERE email='$emailSession'");
...
if (isset($_POST['themgiohang'])) {
    ...
    if ($sql_khachhang) {
        ...
        if (isset($_POST['thanhtoan_product_id']) && isset($_POST['thanhtoan_soluong'])) {
...
<div class="privacy py-sm-5 py-4">
    <div class="container py-xl-4 py-lg-2">
        <!-- tittle heading -->
        <h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">Giỏ hàng của bạn</h3>
        <?php
                        ...
                        <table class="timetable_sub">
                            ...
                            <tbody>
                                ...
                                while ($row_fetch_giohang = mysqli_fetch_array($sql_lay_giohang)) {
                                    $i++;
                                    $soluong = $row_fetch_giohang['soluong'];
                                    $giasanpham = $row_fetch_giohang['giasanpham'];
                                    $subtotal = $soluong * $giasanpham;
                                    $total += $subtotal;
                                ?>
                                    <tr class="rem1">
                                        ...
                                        <td class="invert">
                                            <input type="hidden" name="sanpham_id[]" value="<?php echo $row_fetch_giohang['sanpham_id'] ?>">
                                        ...
                                        <td class="invert"><?php echo number_format($giasanpham, 0, ',', '.') ?> VNĐ</td>
                                        <td class="invert"><?php echo number_format($subtotal, 0, ',', '.') ?> VNĐ</td>
                                        <td class="invert">
                                ...
                                <?php } ?>
                                <tr>
                                    <td colspan="7">Tổng tiền: <?php echo number_format($total, 0, ',', '.') ?> VNĐ</td>
                                </tr>
                                <tr>
                                    <td colspan="7">
                                ...
                                <div class="information-wrapper">
                                    <div class="first-row">
                                        <div class="controls form-group">
                                            <input class="billing-address-name form-control" type="text" name="name" placeholder="Fullname" required="">
                                        </div>
