    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
                ...
                $sql_select = mysqli_query($con, "
                    SELECT * 
                    FROM tbl_giaodich 
                    JOIN tbl_khachhang ON tbl_giaodich.khachhang_id = tbl_khachhang.khachhang_id 
                    JOIN tbl_sanpham ON tbl_giaodich.sanpham_id = tbl_sanpham.sanpham_id 
                    WHERE tbl_giaodich.magiaodich = '$magiaodich' 
            ...
            <div class="col-md-12">
                ...
                $sql_select_khachhang = mysqli_query($con, "
                    SELECT tbl_khachhang.khachhang_id, tbl_khachhang.name, tbl_khachhang.phone, tbl_khachhang.address, tbl_khachhang.email, tbl_giaodich.ngaythang, tbl_giaodich.magiaodich 
                    FROM tbl_khachhang 
                    JOIN tbl_giaodich ON tbl_khachhang.khachhang_id = tbl_giaodich.khachhang_id 
                    GROUP BY tbl_giaodich.magiaodich, tbl_khachhang.khachhang_id, tbl_khachhang.name, tbl_khachhang.phone, tbl_khachhang.address, tbl_khachhang.email, tbl_giaodich.ngaythang 
