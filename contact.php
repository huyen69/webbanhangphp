			...
			<div class="row header-bot_inner_wthreeinfo_header_mid">
				...
				<div id="main-bar" style="text-align: center;">
						<a href="index.php" class="font-weight-bold font-italic">
							<img src="images/logo.png" alt style ="text-align:center; height: 80px;" class="img-fluid">
						</a>
			...
			<div class="row contact-grids agile-1 mb-5">
				...
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							<a href="mailto:info@example.com">minhhuyen@gmail.com</a>
							<label>
								<a href="mailto:info@example.com">Hueyn@gmail.com</a>
							</label>
						</p>
					</div>
				</div>
